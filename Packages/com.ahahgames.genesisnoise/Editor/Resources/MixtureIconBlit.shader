Shader "Hidden/GenesisIconBlit"
{
    Properties
    {
        _GenesisIcon ("Texture", 2D) = "" {}
	...
	SubShader
    {
        ...
        Pass
        {
            ...
            Texture2D _GenesisIcon;
            float4 _GenesisIcon_ST;
            ...
            v2f vert (appdata v)
            {
                ...
                o.uv = TRANSFORM_TEX(v.uv, _GenesisIcon);
                return o;
            }
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float4 iconColor = 0;
				if (all(iconUV < 1))
					iconColor = _GenesisIcon.SampleLevel(s_linear_clamp_sampler, iconUV, 0);
#if CRT_2D
