...
{
    [NodeCustomEditor(typeof(NoiseScaledPoissonDiskPointsNode))]
    public class NoiseScaledPoissonDiskPointsNodeView : GenesisNodeView
    {
        NoiseScaledPoissonDiskPointsNode node => nodeTarget as NoiseScaledPoissonDiskPointsNode;
