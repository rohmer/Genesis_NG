...
{
    [NodeCustomEditor(typeof(GreyNoisePointsNode))]
    public class GreyNoisePointsNodeView : GenesisNodeView
    {
        GreyNoisePointsNode node => nodeTarget as GreyNoisePointsNode;
