...
{
    [NodeCustomEditor(typeof(BrownianNoisePointsNode))]
    public class BrownianNoisePointsNodeView : GenesisNodeView
    {
        BrownianNoisePointsNode node => nodeTarget as BrownianNoisePointsNode;
