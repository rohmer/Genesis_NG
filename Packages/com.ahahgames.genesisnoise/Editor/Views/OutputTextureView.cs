...
namespace AhahGames.GenesisNoise.Views
{
    public class OutputTextureView : VisualElement
    {
        ...
        public OutputTextureView(GenesisGraphView graphView, OutputNodeView nodeView, OutputTextureSettings targetSettings)
        {
        ...
        void InitializeView()
        {
            ...
            {
                targetSettings.compressionQuality = (TextureCompressionQuality)quality.newValue;
            });
