...
{
    [NodeCustomEditor(typeof(NoiseWeightedRandomPointsNode))]
    public class NoiseWeightedRandomPointsNodeView : GenesisNodeView
    {
        NoiseWeightedRandomPointsNode node => nodeTarget as NoiseWeightedRandomPointsNode;
