...
{
    [NodeCustomEditor(typeof(BlueNoisePointsNode))]
    public class BlueNoisePointsNodeView : GenesisNodeView
    {
        BlueNoisePointsNode node => nodeTarget as BlueNoisePointsNode;
