...
namespace AhahGames.GenesisNoise
{
    ...
    public static class HistogramUtility
    {
        ...
        static ComputeShader histogramCompute
        {
            get
            {
                if (_histogramCompute == null)
                    _histogramCompute = Resources.Load<ComputeShader>("GenesisNoise/Histogram");
        ...
        public static void ComputeHistogram(CommandBuffer cmd, Texture input, HistogramData data)
        {
            ...
            {
                GenesisNoiseUtility.SetupComputeTextureDimension(cmd, histogramCompute, input.dimension);
                ...
                GenesisNoiseUtility.SetTextureWithDimension(cmd, histogramCompute, computeLuminanceBufferKernel, "_Input", input);
                ...
                cmd.SetComputeVectorParam(histogramCompute, "_RcpTextureSize", new Vector4(1.0f / input.width, 1.0f / input.height, 1.0f / TextureUtils.GetSliceCount(input), 0));
                GenesisNoiseUtility.SetTextureWithDimension(cmd, histogramCompute, generateHistogramKernel, "_Input", input);
