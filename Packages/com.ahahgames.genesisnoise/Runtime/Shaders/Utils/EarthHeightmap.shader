...
{	
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "Packages/com.ahahgames.genesisnoise/Runtime/Shaders/GenesisBlit.hlsl"
			#include "Packages/com.ahahgames.genesisnoise/Runtime/Shaders/GenesisSRGB.hlsl"
