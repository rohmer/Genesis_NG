...
")]
    [System.Serializable, NodeMenuItem("Generators/Points/Pink Noise Points")]
    public class PinkNoisePointsNode : GenesisNode
    {
        ...
        public override string name => "Pink Noise Points";
        ...
        bool TryBuildCumulativeWeights(int resolution, out float totalWeight)
        {
            ...
            float safeFalloff = Mathf.Clamp(amplitudeFalloff, 0.1f, 0.95f);
            ...
            for (int y = 0; y < resolution; y++)
            {
                ...
                for (int x = 0; x < resolution; x++)
                {
                    ...
                    float density = PinkNoise01(u, v, safeBaseFrequency, safeOctaves, safeFalloff, seed);
        ...
        static float PinkNoise01(float u, float v, float baseFrequency, int octaves, float amplitudeFalloff, int seed)
        {
            ...
            {
                sum += ValueNoise(u * frequency, v * frequency, seed + octave * 1013) * amplitude;
