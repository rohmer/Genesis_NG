...
{
    [Serializable]
    public class OutputNode : GenesisNode, IUseCustomRenderTextureProcessing
    {
        [Input, SerializeField, HideInInspector]
        public List<OutputTextureSettings> outputTextureSettings = new();
        ...
        public override Texture previewTexture => outputTextureSettings.Count > 0 ? outputTextureSettings[selectedPreviewIndex].finalCopyRT : null;
        ...
        //TODO: Add this to the node settings
        [HideInInspector]
        public override bool isOutputNode => true;
        ...
        [NonSerialized]
        protected HashSet<string> uniqueMessages = new();
        ...
        {
            var finalCopyShader = Shader.Find("Hidden/Genesis/FinalCopy");

            if (finalCopyShader == null)
            {
                Debug.LogError("Can't find Hidden/Genesis/FinalCopy shader");
                return null;
            }
        ...
        bool UpdateFinalCopyMaterial(OutputTextureSettings targetOutput)
        {
            ...
            if (input != null)
            {
                ...
                GenesisNoiseUtility.SetupDimensionKeyword(targetOutput.finalCopyMaterial, input.dimension);
        ...
        [CustomPortInput(nameof(outputTextureSettings), typeof(MaterialTextureSettings))]
