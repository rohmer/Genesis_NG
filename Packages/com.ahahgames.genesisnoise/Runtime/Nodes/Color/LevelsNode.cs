...
")]
    ...
    public class Levels : ComputeShaderNode
    {
        ...
        protected override string computeShaderResourcePath => "GenesisNoise/Histogram";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            var mat = tempRenderTexture.material = GetTempMaterial("Hidden/Genesis/Levels");
            ...
            GenesisNoiseUtility.SetupDimensionKeyword(mat, tempRenderTexture.dimension);
            GenesisNoiseUtility.SetTextureWithDimension(mat, "_Input", input);
