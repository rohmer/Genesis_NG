...
")]
    ...
    [System.Serializable, NodeMenuItem("Mesh/Mesh To Volume")]
    public class MeshToUDF : ComputeShaderNode
    {
        ...
        public GenesisMesh inputMesh = new();
        ...
        protected override string computeShaderResourcePath => "GenesisNoise/MeshToSDF";

        public override Texture previewTexture => outputVolume;
        public override bool showDefaultInspector => true;
        protected override GenesisNoiseSettings defaultSettings => Get3DOnlyRTSettings(base.defaultSettings);
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            UpdateTempRenderTexture(ref outputVolume);
            UpdateTempRenderTexture(ref rayMapBuffer, overrideGraphicsFormat: GraphicsFormat.R32_UInt);
            GenesisNoiseUtility.SetupComputeTextureDimension(cmd, computeShader, TextureDimension.Tex3D);
            ...
            GenesisNoiseUtility.RasterizeMeshToTexture3D(cmd, inputMesh, outputVolume, conservativeRaster);
