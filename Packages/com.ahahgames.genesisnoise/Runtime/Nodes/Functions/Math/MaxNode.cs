    ...
    public class MaxNode : ConstantNode
    {
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (outputType == typeof(Vector2))
            {
                ...
                output = new Vector2(MathF.Max(t1.x, t2.x), MathF.Log(t1.y, t2.y));
            }
            if (outputType == typeof(Vector3))
            {
                ...
                output = new Vector3(MathF.Max(t1.x, t2.x), MathF.Max(t1.y, t2.y), MathF.Max(t1.z, t2.z));
            }
            if (outputType == typeof(Vector4))
            {
                ...
                output = new Vector4(MathF.Max(t1.x, t2.x), MathF.Max(t1.y, t2.y), MathF.Max(t1.z, t2.z), MathF.Max(t1.w, t2.w));
            }
            if (outputType == typeof(Vector2Int))
            {
                ...
                output = new Vector2Int((int)MathF.Max(t1.x, t2.x), (int)MathF.Max(t1.y, t2.y));
            }
            if (outputType == typeof(Vector3Int))
            {
                ...
                output = new Vector3Int((int)MathF.Max(t1.x, t2.x), (int)MathF.Max(t1.y, t2.y), (int)MathF.Max(t1.z, t2.z));
            }
            if (outputType == typeof(Quaternion))
            {
                ...
                Quaternion o;
                o.x = MathF.Max(t1.x, t2.x);
                o.y = MathF.Max(t1.y, t2.y);
                o.z = MathF.Max(t1.z, t2.z);
                o.w = MathF.Max(t1.w, t2.w);
                output = o;
            }
            ...
            if (outputType == typeof(Color))
            {
                ...
                output = new Color(MathF.Max(t1.r, t2.r), MathF.Max(t1.g, t2.g), MathF.Max(t1.b, t2.b), MathF.Max(t1.a, t2.a));
            }
            return true;
        }
    }
