    ...
    public class LogNode : ConstantNode
    {
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (outputType == typeof(Vector2))
            {
                ...
                output = new Vector2(MathF.Log(t1.x, t2.x), MathF.Log(t1.y, t2.y));
            }
            if (outputType == typeof(Vector3))
            {
                ...
                output = new Vector3(MathF.Log(t1.x, t2.x), MathF.Log(t1.y, t2.y), MathF.Log(t1.z, t2.z));
            }
            if (outputType == typeof(Vector4))
            {
                ...
                output = new Vector4(MathF.Log(t1.x, t2.x), MathF.Log(t1.y, t2.y), MathF.Log(t1.z, t2.z), MathF.Log(t1.w, t2.w));
            }
            if (outputType == typeof(Vector2Int))
            {
                ...
                output = new Vector2Int((int)MathF.Log(t1.x, t2.x), (int)MathF.Log(t1.y, t2.y));
            }
            if (outputType == typeof(Vector3Int))
            {
                ...
                output = new Vector3Int((int)MathF.Log(t1.x, t2.x), (int)MathF.Log(t1.y, t2.y), (int)MathF.Log(t1.z, t2.z));
            }
            if (outputType == typeof(Quaternion))
            {
                ...
                Quaternion o;
                o.x = MathF.Log(t1.x, t2.x);
                o.y = MathF.Log(t1.y, t2.y);
                o.z = MathF.Log(t1.z, t2.z);
                o.w = MathF.Log(t1.w, t2.w);
                output = o;
            }
            ...
            if (outputType == typeof(Color))
            {
                ...
                output = new Color(MathF.Log(t1.r, t2.r), MathF.Log(t1.g, t2.g), MathF.Log(t1.b, t2.b), MathF.Log(t1.a, t2.a));
            }
            return true;
        }
    }
