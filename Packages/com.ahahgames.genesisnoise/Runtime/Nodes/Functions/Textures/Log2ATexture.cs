...
{
    [System.Serializable, NodeMenuItem("Function/Texture/Texture LOG2(A)")]
    public class Log2ATextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture LOG2(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureLog2");
