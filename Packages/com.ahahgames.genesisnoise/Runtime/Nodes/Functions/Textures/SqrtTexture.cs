...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture SQRT(1-A^2)")]
    public class SqrtTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture SQRT(1-A^2)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureSQRT");
