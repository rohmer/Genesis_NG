...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture ATAN2(A,B)")]
    public class ATan2TextureNode : TextureMathNode
    {
        public override string name => "Texture ATAN2(A,B)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureATAN2");
            ...
            {
                shader.SetTexture(kernel,"inputB", Texture2D.blackTexture);
            }
