...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture ABS(A)")]
    public class ABSTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture ABS(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureABS");
