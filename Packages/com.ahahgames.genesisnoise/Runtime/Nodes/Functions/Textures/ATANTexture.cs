...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture ATAN(A)")]
    public class ATanTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture ATAN(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureATAN");
