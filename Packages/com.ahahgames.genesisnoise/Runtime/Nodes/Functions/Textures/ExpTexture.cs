...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture EXP(A)")]
    public class ExpTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture EXP(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureEXP");
