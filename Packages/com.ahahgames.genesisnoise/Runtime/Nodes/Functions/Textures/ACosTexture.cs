...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture ACOS(A)")]
    public class ACosTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture ACOS(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureACOS");
