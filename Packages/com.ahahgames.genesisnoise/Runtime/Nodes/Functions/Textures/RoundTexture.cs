...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture ROUND(A)")]
    public class RoundTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture ROUND(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureROUND");
