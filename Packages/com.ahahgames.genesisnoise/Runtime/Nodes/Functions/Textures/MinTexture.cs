...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture Minimum")]
    public class MinTextureNode : TextureMathNode
    {
        public override string name => "Texture Minimum";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureMinimum");
