...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture SIN(A*B)")]
    public class SinABTextureNode : TextureMathNode
    {
        public override string name => "Texture SIN(A*B)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureSINAB");
