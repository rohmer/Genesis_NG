...
{
    [System.Serializable, NodeMenuItem("Function/Texture/Texture SINH(A)")]
    public class SinHTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture SINH(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureSINH");
