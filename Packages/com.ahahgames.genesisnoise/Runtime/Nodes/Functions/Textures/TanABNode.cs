...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture TAN(A*B)")]
    public class TANABTextureNode : TextureMathNode
    {
        public override string name => "Texture TAN(A*B)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureTANAB");
