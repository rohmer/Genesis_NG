...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture TANH(A)")]
    public class TanHTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture TANH(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureTANH");
