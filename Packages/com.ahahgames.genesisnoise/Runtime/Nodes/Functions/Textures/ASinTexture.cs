...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture ASIN(A)")]
    public class ASinTextureNode : GenesisNode
    {
        [Input(name = "A")]
        ...
        public override string name => "Texture ASIN(A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureASIN");
