...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture Addition")]
    public class AddTextureNode : TextureMathNode
    {
        public override string name => "Texture Addition";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureAddition");
