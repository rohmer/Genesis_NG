...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Constant/Texture")]
    public class TextureNode : GenesisNode, ICreateNodeFrom<Texture>
    {
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (normalMap)
            {
                ...
                var blitMaterial = GetTempMaterial("Hidden/Genesis/TextureNode");
                GenesisNoiseUtility.SetTextureWithDimension(blitMaterial, "_Source", textureAsset);
                blitMaterial.SetInt("_POTMode", (int)POTMode);
                GenesisNoiseUtility.Blit(cmd, blitMaterial, textureAsset, postProcessedTexture, 0);
            ...
            else if (needsTempTarget)
            {
                ...
                GenesisNoiseUtility.SetTextureWithDimension(blitMaterial, "_Source", textureAsset);
                blitMaterial.SetInt("_POTMode", (int)POTMode);
                GenesisNoiseUtility.Blit(cmd, blitMaterial, textureAsset, postProcessedTexture, 1);
