...
| [Blue Noise](_nodes/generators/noise-blue-noise.md) | The BlueNoise node generates a higha'quality, tilea'free, spatially uniform bluea'noise mask using a Hilberta'curve R1 quasirandom sequence. |
| [Blue Noise Points](_nodes/generators/noise-blue-noise-points.md) | Generates a blue-noise style point set using Poisson disk sampling and outputs both a point image and the generated coordinates. |
