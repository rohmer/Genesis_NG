...
| [Random Points](_nodes/generators/points-random-points.md) | Generates a uniformly random set of 2D points and outputs both a point image and the generated coordinates. |
| [Random Points From Noise](_nodes/generators/points-random-points-from-noise.md) | Generates random 2D points using a noise texture as a probability map, so brighter areas are sampled more often than darker ones. |
