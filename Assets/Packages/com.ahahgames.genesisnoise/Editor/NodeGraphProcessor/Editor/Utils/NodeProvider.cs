...
namespace GraphProcessor
{
    public static class NodeProvider
    {
        ...
        static Dictionary<Type, MonoScript> nodeViewScripts = new();
        static Dictionary<Type, MonoScript> nodeScripts = new();
        static Dictionary<Type, Type> nodeViewPerType = new();
        ...
        static Dictionary<BaseGraph, NodeDescriptions> specificNodeDescriptions = new();
        static List<NodeSpecificToGraph> specificNodes = new();

        static NodeDescriptions genericNodes = new();
        ...
        static bool IsNodeSpecificToGraph(Type nodeType)
        {
            ...
            List<MethodInfo> compatibleMethods = new();
