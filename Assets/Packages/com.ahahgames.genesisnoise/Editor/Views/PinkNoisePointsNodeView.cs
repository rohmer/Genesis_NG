...
{
    [NodeCustomEditor(typeof(PinkNoisePointsNode))]
    public class PinkNoisePointsNodeView : GenesisNodeView
    {
        PinkNoisePointsNode node => nodeTarget as PinkNoisePointsNode;
