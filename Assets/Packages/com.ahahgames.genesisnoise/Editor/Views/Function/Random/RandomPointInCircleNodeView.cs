...
{
    [NodeCustomEditor(typeof(RandomPointInCircleNode))]
    public class RandomPointInCircleNodeView : GenesisNodeView
    {
        RandomPointInCircleNode node => nodeTarget as RandomPointInCircleNode;
        Vector2Field p1;
        FloatField radius;
