...
{
    [NodeCustomEditor(typeof(PoissonDiskPointsNode))]
    public class PoissonDiskPointsNodeView : GenesisNodeView
    {
        PoissonDiskPointsNode node => nodeTarget as PoissonDiskPointsNode;
