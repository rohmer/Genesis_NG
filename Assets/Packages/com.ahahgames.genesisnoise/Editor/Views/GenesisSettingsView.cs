...
{
    public class GenesisSettingsView : VisualElement
    {
        const float k_MaxSizeScale = 64;

        // Keep a second version of enums from GenesisNode.cs without the Inherit fields for the graph settings:
        ...
        public GenesisSettingsView(GenesisNoiseSettings settings, GenesisGraphView owner, string title = "Node Output Settings", bool showSettingsForNode = true)
        {
            this.graph = owner.graph as GenesisGraph;
        ...
        void AddRealtimeFields(GenesisGraphView owner)
        {
        ...
        void UpdateFieldVisibility(GenesisNoiseSettings settings)
        {
