...
{
    [NodeCustomEditor(typeof(LloydRelaxedPointsNode))]
    public class LloydRelaxedPointsNodeView : GenesisNodeView
    {
        LloydRelaxedPointsNode node => nodeTarget as LloydRelaxedPointsNode;
