...
{
    public static class GenesisNoiseUtility
    {
        public static readonly float defaultNodeWidth = 300f;
        public static readonly float operatorNodeWidth = 100f;
        public static readonly float smallNodeWidth = 200f;
        ...
        public static Material blitIconMaterial
        {
            get
            {
                ...
                {
                    _blitIconMaterial = new Material(Resources.Load<Shader>("GenesisIconBlit"));
                    _blitIconMaterial.SetTexture("_GenesisIcon_32", icon);
        ...
        public static Material blitRealtimeIconMaterial
        {
            get
            {
                ...
                {
                    _blitRealtimeIconMaterial = new Material(Resources.Load<Shader>("GenesisIconBlit"));
                    _blitRealtimeIconMaterial.SetTexture("_GenesisIcon_32", realtimeIcon);
        ...
        public static Material textureArrayPreviewMaterial
        {
            get
            {
                ...
                {
                    _textureArrayPreviewMaterial = new Material(Shader.Find("Hidden/GenesisTextureArrayPreview"));
                }
        ...
        public static Material texture2DPreviewMaterial
        {
            get
            {
                ...
                {
                    _texture2DPreviewMaterial = new Material(Shader.Find("Hidden/GenesisTexture2DPreview"));
                }
        ...
        public static Material texture3DPreviewMaterial
        {
            get
            {
                ...
                {
                    _texture3DPreviewMaterial = new Material(Shader.Find("Hidden/GenesisTexture3DPreview"));
                }
        ...
        public static Material textureCubePreviewMaterial
        {
            get
            {
                ...
                {
                    _textureCubePreviewMaterial = new Material(Shader.Find("Hidden/GenesisTextureCubePreview"));
                }
        ...
        public static Material rasterize3DMaterial
        {
            get
            {
                ...
                {
                    var shader = Shader.Find("Hidden/Genesis/Rasterize3D");
        ...
        {
            get => _windowIcon == null ? _windowIcon = Resources.Load<Texture2D>("Icons/Genesis_32") : _windowIcon;
        }
        static Texture2D _icon;
        public static Texture2D icon
        {
            get => _icon == null ? _icon = Resources.Load<Texture2D>("Icons/Genesis_128") : _icon;
        }

        static Texture2D _icon32;
        public static Texture2D icon32
        {
            get => _icon32 == null ? _icon32 = Resources.Load<Texture2D>("Icons/Genesis_32") : _icon32;
        }

        static Texture2D _iconVariant;
        public static Texture2D iconVariant
        {
            get => _iconVariant == null ? _iconVariant = Resources.Load<Texture2D>("Icons/GenesisVariantIcon_128") : _iconVariant;
        }

        static Texture2D _iconVariant32;
        public static Texture2D iconVariant32
        {
            get => _iconVariant32 == null ? _iconVariant32 = Resources.Load<Texture2D>("Icons/GenesisVariantIcon_32") : _iconVariant32;
        }

        static Texture2D _realtimeIcon;
        public static Texture2D realtimeIcon
        {
            get => _realtimeIcon == null ? _realtimeIcon = Resources.Load<Texture2D>("Icons/GenesisRealtimeIcon_128") : _realtimeIcon;
        }

        static Texture2D _realtimeIcon32;
        public static Texture2D realtimeIcon32
        {
            get => _realtimeIcon32 == null ? _realtimeIcon32 = Resources.Load<Texture2D>("Icons/GenesisRealtimeIcon_32") : _realtimeIcon32;
        }

        static Texture2D _realtimeVariantIcon;
        public static Texture2D realtimeVariantIcon
        {
            get => _realtimeVariantIcon == null ? _realtimeVariantIcon = Resources.Load<Texture2D>("Icons/GenesisRealtimeVariantIcon_128") : _realtimeVariantIcon;
        }

        static Texture2D _realtimeVariantIcon32;
        public static Texture2D realtimeVariantIcon32
        {
            get => _realtimeVariantIcon32 == null ? _realtimeVariantIcon32 = Resources.Load<Texture2D>("Icons/GenesisRealtimeVariantIcon_32") : _realtimeVariantIcon32;
        }

        static ComputeShader _clearCompute;
        public static ComputeShader clearCompute
        {
            get => _clearCompute == null ? _clearCompute = Resources.Load<ComputeShader>("Genesis/Clear") : _clearCompute;
        }
        ...
        public static readonly Dictionary<TextureDimension, string> shaderPropertiesDimensionSuffix = new()
        {
        ...
        static readonly List<TextureDimension> allDimensions = new() {
        ...
        public static List<TextureDimension> GetAllowedDimentions(string propertyName)
        {
            ...
            List<TextureDimension> dimensions = new();
        ...
        public static void Blit(CommandBuffer cmd, Material material, Texture source, RenderTexture target, int shaderPass = 0)
        {
            ...
            props.SetVectorArray("CustomRenderTextureSizesAndRotations", new List<Vector4>() { new(1, 1, 0, 0) });
            props.SetVectorArray("CustomRenderTextureCenters", new List<Vector4>() { new(0.5f, 0.5f, 0, 0) });
        ...
        public static void RasterizeMeshToTexture3D(CommandBuffer cmd, GenesisMesh mesh, RenderTexture outputVolume, bool conservative = false)
        {
            var props = new MaterialPropertyBlock();
