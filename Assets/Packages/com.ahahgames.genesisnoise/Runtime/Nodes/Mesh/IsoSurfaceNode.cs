...
")]
    ...
    public class IsoSurface : ComputeShaderNode
    {
        ...
        [Output("Mesh")]
        public GenesisMesh output;

        public float threshold;

        public override string name => "Marching Cubes";

        protected override string computeShaderResourcePath => "GenesisNoise/MarchingCubes";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            GenesisGraphProcessor.AddGPUAndCPUBarrier(cmd);
            ...
            output = new GenesisMesh { mesh = mesh };
