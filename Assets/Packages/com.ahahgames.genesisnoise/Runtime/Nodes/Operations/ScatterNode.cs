...
")]
    [System.Serializable, NodeMenuItem("Operations/Scatter")]
    public class Scatter : ComputeShaderNode
    {
        ...
        {
            Blend, PreMultiplied, Additive, SoftAdditive, Subtractive, Multiplicative, Max, Min,
        }
        ...
        [Input]
        public List<Texture> inputTextures = new();
        ...
        public Vector2 gridScale = new(8, 8);
        [VisibleIf(nameof(sequence), Sequence.Grid)]
        ...
        public Vector3 minScale = new(0.5f, 0.5f, 0.5f);
        [ShowInInspector, VisibleIf(nameof(scaleMode), ScaleMode.RandomBetween)]
        public Vector3 maxScale = new(1.5f, 1.5f, 1.5f);

        [VisibleIf(nameof(mode), Mode.Sprite)]
        ...
        protected override string computeShaderResourcePath => "GenesisNoise/Splatter";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            var drawIndirectMat = GetTempMaterial("Hidden/Genesis/Splatter");
            ...
            for (int i = 0; i < inputTextures.Count; i++)
                drawIndirectMat.SetTexture("_Source" + i + GenesisNoiseUtility.texture2DPrefix, inputTextures[i]);
