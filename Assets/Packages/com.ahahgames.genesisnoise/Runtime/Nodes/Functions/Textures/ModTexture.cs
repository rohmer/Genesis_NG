...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture MOD(A,B)")]
    public class MODABTextureNode : TextureMathNode
    {
        public override string name => "Texture MOD(A,B)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureMODAB");
