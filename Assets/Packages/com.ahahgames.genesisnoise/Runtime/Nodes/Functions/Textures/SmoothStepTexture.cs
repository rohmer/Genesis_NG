...
")]
    ...
    [System.Serializable, NodeMenuItem("Function/Texture/Texture Smoothstep(0,1,A)")]
    public class SmoothStepTexture: GenesisNode
    {
        [Input(name = "A")]
        ...
        [Input(name = "Lower Bound")]
        public float LowerBound = 0f;

        [Input(name = "Upper Bound")] 
        public float UpperBound = 1f;

        protected ComputeShader shader = null;
        public override string name => "Texture Smoothstep(0,1,A)";
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (inputA == null)
                return true;
            shader = Resources.Load<ComputeShader>("Shaders/Functions/Math/TextureSmoothStep");
