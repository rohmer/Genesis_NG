...
")]
    ...
    [System.Serializable, NodeMenuItem("Conditional/While Do Start"), NodeMenuItem("Conditional/Do While Start")]
    public class WhileDoStart : GenesisNode, ILoopStart
    {
        [Input]
        public object input;
        ...
        public override string name => "While Do Start";
