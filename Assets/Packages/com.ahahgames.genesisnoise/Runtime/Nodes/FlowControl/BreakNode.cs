...
")]
    [System.Serializable, NodeMenuItem("Conditional/Break")]
    public class BreakNode : GenesisNode
    {
        [Input]
        public object input;
        ...
        protected override bool ProcessNode(CommandBuffer cmd)
        {
            ...
            if (condition && graph != null)
                GenesisGraphProcessor.GetOrCreate(graph)?.RequestLoopControl(LoopControlSignal.Break);
