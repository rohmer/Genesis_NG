...
float4 GenesisRemap(float4 i, float4 inputMin, float4 inputMax, float4 outputMin, float4 outputMax) { return outputMin + (i - inputMin) * (outputMax - outputMin) / (inputMax - inputMin); }
float3 GenesisRemap(float3 i, float3 inputMin, float3 inputMax, float3 outputMin, float3 outputMax) { return outputMin + (i - inputMin) * (outputMax - outputMin) / (inputMax - inputMin); }
float2 GenesisRemap(float2 i, float2 inputMin, float2 inputMax, float2 outputMin, float2 outputMax) { return outputMin + (i - inputMin) * (outputMax - outputMin) / (inputMax - inputMin); }
float GenesisRemap(float i, float inputMin, float inputMax, float outputMin, float outputMax) { return outputMin + (i - inputMin) * (outputMax - outputMin) / (inputMax - inputMin); }
...
TEMPLATE_FLT_5(RemapClamp, i, inputMin, intputMax, outputMin, outputMax, return SmartClamp(GenesisRemap(i, inputMin, intputMax, outputMin, outputMax), outputMin, outputMax))
