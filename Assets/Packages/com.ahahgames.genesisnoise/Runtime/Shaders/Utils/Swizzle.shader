...
{	
	Properties
	{
		...
		[GenesisSwizzle]_RMode("Output Red", Float) = 0
		[GenesisSwizzle]_GMode("Output Green", Float) = 1
		[GenesisSwizzle]_BMode("Output Blue", Float) = 2
		[GenesisSwizzle]_AMode("Output Alpha", Float) = 3
