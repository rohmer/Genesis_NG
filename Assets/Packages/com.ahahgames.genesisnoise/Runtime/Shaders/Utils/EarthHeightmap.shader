...
{	
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "Assets/Packages/com.ahahgames.genesisnoise/Runtime/Shaders/GenesisBlit.hlsl"
			#include "Assets/Packages/com.ahahgames.genesisnoise/Runtime/Shaders/GenesisSRGB.hlsl"
			...
			float4 Fragment(Varyings i) : SV_Target
			{
				...
				switch (_Mode)
				{
					...
					case 0: // raw:
						return height;
					case 1: // remap:
						return GenesisRemap(height, _MinHeight, _MaxHeight, _RemapMin, _RemapMax);
					case 2: // Scale:
