...
namespace AhahGames.GenesisNoise
{
    ...
    {
        static Dictionary<TextureDimension, Texture> blackTextures = new();
        static Dictionary<TextureDimension, Texture> whiteTextures = new();

        // Do not change change these names, it would break all graphs that are using default texture values
        static readonly string blackDefaultTextureName = "Genesis Black";
        static readonly string whiteDefaultTextureName = "Genesis white";
        ...
        {
            RenderTexture rt = new(1, 1, 0, GraphicsFormat.R8G8B8A8_UNorm, 1)
            {
                volumeDepth = 1,
                dimension = dim,
        ...
        public static bool IsGenesisDefaultTexture(this Texture texture)
        ...
        static ProfilingSampler copyTextureSampler = new("Copy Texture");
