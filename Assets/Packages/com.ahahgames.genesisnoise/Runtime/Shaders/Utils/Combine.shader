...
{	
	Properties
	{
		...
		[Tooltip(Select which channel from the R input texture to write in the R output channel)][GenesisSwizzle]_CombineModeR("Output R", Float) = 0
		[Tooltip(Select which channel from the G input texture to write in the G output channel)][GenesisSwizzle]_CombineModeG("Output G", Float) = 1
		[Tooltip(Select which channel from the B input texture to write in the B output channel)][GenesisSwizzle]_CombineModeB("Output B", Float) = 2
		[Tooltip(Select which channel from the A input texture to write in the A output channel)][GenesisSwizzle]_CombineModeA("Output A", Float) = 3
