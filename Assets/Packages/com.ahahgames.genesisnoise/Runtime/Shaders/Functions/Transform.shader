...
{	
	Properties
	{
		...
		// Other parameters
		[GenesisVector3]_PositionOffset("Position Offset", Vector) = (0, 0, 0, 0)
		[Tooltip(Rotation in euler angles between 0 and 360)][GenesisVector3]_Rotation("Rotation", Vector) = (0, 0, 0, 0)
		[GenesisVector3]_Scale("Scale", Vector) = (1, 1, 1, 1)
	}
	SubShader
	{
