...
{	
	Properties
	{
		...
		[ShowInInspector][GenesisVector2]_OutputRange("Output Range", Vector) = (-1, 1, 0, 0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "Assets/Packages/com.ahahgames.genesisnoise/Runtime/Shaders/CellularNoise.hlsl"
