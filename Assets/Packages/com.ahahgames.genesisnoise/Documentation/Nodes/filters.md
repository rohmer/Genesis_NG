...
| Node | Summary |
| --- | --- |
| [Canvas](_nodes/filters/artistic-canvas.md) | Paper/canvas fiber grain |
| [Cartoon](_nodes/filters/artistic-cartoon.md) | Edge detection (Sobel-style) |
| [Old Photo](_nodes/filters/artistic-old-photo.md) | Sepia toning |
...
| Node | Summary |
| --- | --- |
| [Difference of Gaussians](_nodes/filters/edge-detect-difference-of-gaussians.md) | computes a Difference of Gaussians (DoG) edge response. It performs two small separable Gaussian-like blurs at different radii, subtracts them to produce band-pass edges, applie... |
| [Edge Detection](_nodes/filters/edge-detect-edge-detection.md) | Edge detection using one of a few different algorithms |
