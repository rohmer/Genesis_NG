...
![Snapshot of Tile Sampler](../../_images/tiling/tile-sampler.png)

## Details

- Menu: `Tiling/Tile Sampler`
- Node group: `Tiling`
- Shader: `Hidden/Genesis/TileSampler`
- Source: [Runtime/Nodes/Tiling/TileSamplerNode.cs](../../../Doxygen/html/_tile_sampler_node_8cs_source.html)
