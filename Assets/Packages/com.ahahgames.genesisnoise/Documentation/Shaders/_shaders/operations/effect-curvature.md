...
- Category: `Operations`
- Source: [Runtime/Shaders/Operations/Effect/Curvature.shader](../../../Doxygen/html/_curvature_8shader_source.html)
- Texture inputs: 3
- Parameters: 4
- Linked nodes: 1
...
| Node | Menu | Summary |
| --- | --- | --- |
| [Curvature](../../../Nodes/_nodes/effects/curvature.md) | `Effects/Curvature` | Simulates Substance's Curvature node from a height map: convex/concave detection via a Laplacian-style kernel, remapped to 0-1, with optional separate convex/concave outputs. |
