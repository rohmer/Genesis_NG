...
- Category: `Operations`
- Source: [Runtime/Shaders/Operations/Effect/CurvatureSmooth.shader](../../../Doxygen/html/_curvature_smooth_8shader_source.html)
- Texture inputs: 3
- Parameters: 5
- Linked nodes: 1
...
| Node | Menu | Summary |
| --- | --- | --- |
| [Curvature Smooth](../../../Nodes/_nodes/effects/curvature-smooth.md) | `Effects/Curvature Smooth` | Simulates Substance's Curvature Smooth node from a height map: convex/concave detection via a Laplacian-style kernel, remapped to 0-1, with optional separate convex/concave outp... |
