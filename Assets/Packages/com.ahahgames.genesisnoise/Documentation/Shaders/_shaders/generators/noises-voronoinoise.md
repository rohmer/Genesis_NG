...
- Category: `Generators`
- Source: [Runtime/Shaders/Generators/Noises/VoronoiNoise.shader](../../../Doxygen/html/_voronoi_noise_8shader_source.html)
- Texture inputs: 9
- Parameters: 10
- Linked nodes: 1
...
| Node | Menu | Summary |
| --- | --- | --- |
| [Voronoi Noise](../../../Nodes/_nodes/generators/noise-voronoi-noise.md) | `Generators/Noise/Voronoi Noise` | The VoronoiNoise node generates 2D, 3D, or Cube-space Voronoi (Worley) noise with an extensive set of controls: |
