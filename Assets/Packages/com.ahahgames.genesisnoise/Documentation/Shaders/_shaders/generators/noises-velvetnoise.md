...
- Category: `Generators`
- Source: [Runtime/Shaders/Generators/Noises/VelvetNoise.shader](../../../../Runtime/Shaders/Generators/Noises/VelvetNoise.shader)
- Texture inputs: 3
- Parameters: 9
- Linked nodes: 1
...
| `_Seed` | Seed | `Int` | `42` |  |  |
| `_Channels` | Channels | `Int` | `0` | Select how many noise values to generate and which channels to write. More channels cost more impulse evaluations. | ShowInInspector, Enum(RRRR, 0, R, 1, RG, 2, RGB, 3, RGBA, 4) |
...
| Node | Menu | Summary |
| --- | --- | --- |
| [Velvet Noise](../../../Nodes/_nodes/generators/noise-velvet-noise.md) | `Generators/Noise/Velvet Noise` | The VelvetNoise node generates deterministic, sampler-free velvet noise in 2D, 3D, or Cube space. |
