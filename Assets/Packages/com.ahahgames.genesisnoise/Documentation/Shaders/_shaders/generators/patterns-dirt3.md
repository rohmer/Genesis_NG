...
- Category: `Generators`
- Source: [Runtime/Shaders/Generators/Patterns/Dirt3.shader](../../../Doxygen/html/_dirt3_8shader_source.html)
- Texture inputs: 1
- Parameters: 21
- Linked nodes: 1
...
| Property | Label | Type | Default | Tooltip | Attributes |
| --- | --- | --- | --- | --- | --- |
| `_Preset` | Preset | `int` | `0` |  | Enum(Default,0, Coastal,1, Urban,2, Rusty,3, FineSpeckle,4, LongStreaks,5, HeavyCrevice,6, Painterly,7) |
