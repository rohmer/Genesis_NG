...
- Category: `Color`
- Source: [Runtime/Shaders/Color/ReplaceColor.shader](../../../Doxygen/html/_replace_color_8shader_source.html)
- Texture inputs: 3
- Parameters: 11
- Linked nodes: 1
...
| Node | Menu | Summary |
| --- | --- | --- |
| [Replace Color](../../../Nodes/_nodes/color/replace-color.md) | `Color/Replace Color` | Selects a target color |
