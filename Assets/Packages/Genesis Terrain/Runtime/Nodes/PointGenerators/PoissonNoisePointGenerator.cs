...
")]
    ...
    [Serializable, NodeMenuItem("Terrain/Point Generation/Poisson Noise")]
    public class PoissonNoisePointGenerationNode : GenesisNode
    {
        ...
        [SerializeField]
        public eNoiseFunction NoiseFunction = eNoiseFunction.FBM;
        ...
        public override string name => "Poisson Noise Generator";
        ...
        internal void GeneratePoints()
        {
            ...
            if (shader == null)
            {
                shader = Resources.Load<ComputeShader>("GenesisNoise/Terrain/PointGenerator/PoissonDiskNoiseGenerator");
            ...
            shader.SetInt("_NoiseFunction", (int)NoiseFunction);
