Shader "Hidden/Erosion_Deposit"
{
    Properties
    {
        ...
        _DepositRate ("Deposit Rate", Float) = 0.3
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                float capacity = _SedimentCapacity * speed;

                if (s > capacity)
                {
                    float amount = _DepositRate * (s - capacity);
                    h += amount;
                    s -= amount;
                }

                return float4(h, s, 0, 1);
            }
