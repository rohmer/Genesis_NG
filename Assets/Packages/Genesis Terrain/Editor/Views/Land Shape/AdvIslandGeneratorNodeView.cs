...
namespace AhahGames.GenesisNoise.GNTerrain.Views
{
    namespace AhahGames.GenesisNoise.GNTerrain.Views
    {        
        [NodeCustomEditor(typeof(AdvIslandGeneratorNode))]
        public class AdvIslandGeneratorNodeView : GenesisNodeView
        {
            AdvIslandGeneratorNode node => nodeTarget as AdvIslandGeneratorNode;
